...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    READ ENTITIES OF zrap_I_trav_d01 IN LOCAL MODE
     ENTITY travel
...
CLASS lsc_ZRAP_I_TRAV_D01 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZRAP_I_TRAV_D01 IMPLEMENTATION.
